...
public class ChromaItemsASM implements IClassTransformer {
    ...
    private boolean isProblematicClass(String className) {
        return className.equals("Reika.ChromatiCraft.ModInterface.ThaumCraft.ItemManipulatorFocus") ||
               className.equals("Reika.ChromatiCraft.ModInterface.ThaumCraft.ItemAbilityFocus");
    }
}
